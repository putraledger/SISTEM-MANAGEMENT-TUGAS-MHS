...
export default function MahasiswaTelegramPage() {
                ...
                <div className="space-y-4 text-xs text-slate-600 dark:text-slate-300">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-850 p-2.5 rounded-lg font-mono text-[10px] text-slate-850 dark:text-slate-200 select-all font-bold block mt-1.5 max-w-sm">
